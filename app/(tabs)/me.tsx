    ...
    return (
        <View className='bg-secondary w-full h-full'>
            ...
            <View className='h-full'>
                ...
                <SafeAreaView className='w-full h-full bg-black/80 absolute top-0 left-0'>
                    <View className='flex-row items-center justify-between px-4 py-2'>
                        ...
                        {auth.user ? <View className='flex-row space-x-3'>
                            <TouchableOpacity className='p-3 bg-white/5 rounded-lg' onPress={() => navigation.navigate("postsview")}>
                                <Ionicons name='paper-plane-outline' size={18} color={"white"} />
                            </TouchableOpacity>
                            <TouchableOpacity className='p-3 bg-white/5 rounded-lg' onPress={() => navigation.navigate("settings")}>
                ...
                {auth.user ? <TouchableOpacity className='w-16 h-16 rounded-full flex-row justify-center items-center bg-yellow-500 absolute bottom-28 right-[41%]' onPress={handleOpenSheet}>
