        ...
        <LinearGradient className="h-full" colors={["#141414", "black"]} start={{ x: 0, y: 0.2 }}>
            <SafeAreaView className='bg-primar h-full'>
                <View className='px-3 py-2 mb-2 flex-row items-center justify-between'>
                    ...
                    <View className=''>
                        <Text className='text-inverse text-lg font-sansbold'>Creators (2.07M)</Text>
                    </View>
                    <View className='w-4'></View>
                </View>
                <View className='px-3 py-2 mb-2 flex-row items-center'>
                    <View className=' flex-row justify-center items-center'>
                        <TextInput className='bg-secondary text-inverse pb-4 pt-3  px-4 rounded-lg w-full font-sansmedium' placeholder='search creator' placeholderTextColor={"#A5A6A7"} />
                    </View>
                </View>
                <FlatList
