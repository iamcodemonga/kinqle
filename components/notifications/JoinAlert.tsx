        ...
        <View className='flex-row items-center justify-between px-3'>
            <View className='flex-row items-center space-x-3'>
                ...
                <View className='space-y-1'>
                    ...
                    <Text className='text-tertiary text-sm font-sansmedium'>has joined your audience</Text>
                </View>
            </View>
            <View>
                <TouchableOpacity className='w-24 rounded-xl py-2 bg-accent'>
                    <Text className='text-gray-700 text-center text-sm font-sansmedium border border-accent'>View</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
