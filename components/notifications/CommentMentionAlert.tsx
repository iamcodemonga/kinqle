...
const CommentMentionAlert = (props: Props) => {
    return (
        <View>
            <View className='flex-row items-center justify-between px-3 pb-4'>
                <View className='flex-row items-center space-x-3'>
                    ...
                    <View className='space-y-1'>
                        ...
                        <Text className='text-tertiary text-sm font-sansmedium'>mentioned you in a comment</Text>
                    </View>
                </View>
                <View>
            ...
            <View className='mx-3 mb-5'>
                <Text className='text-inverse text-sm' numberOfLines={2}>
                    " <Text className='text-inverse font-sansmedium text-base'><Text className='font-sansbold text-accent'>@codemonga</Text> Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium quos alias, nesciunt ut beatae sapiente, assumenda ea eum temporibus laboriosam consequatur iusto.</Text> "
                </Text>
            </View>
            <TouchableOpacity className='mx-3'>
                ...
                <View className='h-full w-full absolute top-0 left-0 bg-black/50 rounded-xl px-3 py-3 justify-between'>
                    ...
                    <Text className='text-white text-base font-sansmedium' numberOfLines={2}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex porro autem voluptates consectetur quae!</Text>
                </View>
            </TouchableOpacity>
        </View>
    )
...
export default CommentMentionAlert