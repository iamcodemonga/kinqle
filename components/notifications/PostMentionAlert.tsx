...
const PostMentionAlert = (props: Props) => {
    return (
        <View>
            <View className='flex-row items-center justify-between px-3 pb-4'>
                <View className='flex-row items-center space-x-3'>
                    ...
                    <View className='space-y-1'>
                        ...
                        <Text className='text-tertiary text-sm font-sansmedium'>mentioned you in this post</Text>
                    </View>
                </View>
                <View>
            ...
            <TouchableOpacity className='mx-3'>
                ...
                <View className='h-full w-full absolute top-0 left-0 bg-black/50 rounded-xl px-3 py-3 justify-between'>
                    ...
                    <Text className='text-white text-base font-sansmedium' numberOfLines={2}><Text className='text-accent font-sansbold text-base'>@codemonga</Text> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex porro autem voluptates consectetur quae!</Text>
                </View>
            </TouchableOpacity>
        </View>
    )
...
export default PostMentionAlert