...
const ValueCommentAlert = (props: Props) => {
    return (
        <View>
            <View className='flex-row items-center justify-between px-3 pb-4'>
                <View className='flex-row items-center space-x-3'>
                    ...
                    <View className='space-y-1'>
                        ...
                        <Text className='text-tertiary text-sm font-sansmedium'>Valued your contribution</Text>
                    </View>
                </View>
                <View>
                    <TouchableOpacity className='w-24 rounded-xl py-2 bg-accent border border-accent'>
                        <Text className='text-gray-700 text-center text-sm font-sansmedium'>View</Text>
                    </TouchableOpacity>
                </View>
            </View>
...
export default ValueCommentAlert